    ...
    <tbody>
      <tr>
        <td>
          ...
          Todas las capturas fueron tomadas el día miércoles 17 de mayo del 2023, por lo que las ejecuciones que se muestran en las imágenes están de acuerdo a esa fecha. Además, todas las páginas utilizan una misma hoja de estilo creada, así como también tiene una estructura similar, con el número de ejercicio, nombre, enunciado, los datos y su resultado. En este informe se explica la ejecución de las páginas, por lo que se recuerda que la explicacion del código se encuentra en el video del ejercicio 06, y de manera extra también se encuentra otro video explicando la ejecución de las páginas (ejercicio 06). Por otro lado, todo el código que se ha realizado en este laboratorio junto al informe en HTML, se encuentra en la página del repositorio GitHub: https://github.com/mhuamanivar/PW2-HuamaniV-Lab02 , y el ".git" es: https://github.com/mhuamanivar/PW2-HuamaniV-Lab02.git . <br/><br/>
          <ol>
            <li><b>Ejercicio 01: Escriba una función que reciba el número de día de la fecha actual new Date() - https://www.w3schools.com/jsref/jsref_obj_date.asp y devuelva el texto del día de la semana correspondientes. Por ejemplo si recibe 0, devolvería “Domingo”.</b><br/><br/>
              <ul>
                <li>Primero se crea el script con la variable "fechaActual" en donde se almacena el objeto creado con "new Date()" por defecto, es decir, que guarda la fecha actual. Posteriormente, se tiene la variable "numDia", donde se obtiene el número del día con el método "getDay()". Luego creamos la variable "diaSem", en donde llamamos a la función "diaSemana()", y obtenemos el resultado mediante un arreglo, cuya posición corresponde al día exacto, por lo que es sencillo obtener el resultado. Debido a que la captura fue tomada el día "Miércoles 17 de Mayo", entonces el número mostrado es 3, y el texto que retorna es "Miércoles".<br/><br/>
